            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUserSecRole.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserSecRoleInstance, field: "id")}</td>

                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="relacionPersona" title="${message(code: 'persona.relacionPersona.label', default: 'Relacion Persona')}" />
                    ...
                    <g:each in="${personaInstanceList}" status="i" var="personaInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: personaInstance, field: "relacionPersona")}</td>

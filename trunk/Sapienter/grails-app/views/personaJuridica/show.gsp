	...
	<div class="body">
				...
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.id.label" default="Id" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "id")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.razonSocial.label" default="Razon Social" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "razonSocial")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.cuit.label" default="Cuit" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "cuit")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								...
								default="Telefono De Contacto" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "telefonoDeContacto")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.email.label" default="Email" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "email")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.fax.label" default="Fax" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "fax")}
						</td>
					...
					<tr class="prop">
						<td valign="top" class="name"><g:message
								code="personaJuridica.auxiliares.label" default="Auxiliares" />
						</td>

						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "auxiliares")}
						</td>
					...
					<tr class="prop">
						...
						<td valign="top" class="value">
							${fieldValue(bean: personaJuridicaInstance, field: "observaciones")}
						</td>
		...
		<div class="buttons">
			<g:form>
				...
				<span class="button"><g:actionSubmit class="Crear Proceso"
						action="crearProceso"
						value="${message(code: 'default.button.crearProceso.label', default:'Crear Proceso')}" />
				</span>
			</g:form>
		</div>
	</div>

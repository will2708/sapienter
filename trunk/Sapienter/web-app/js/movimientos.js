...
$(function() {
		...
		var fechaC = $("#fechaDeCreacion").val();
		var fechaV = $("#fechaDeVencimiento").val();
		
		$( "#fechaDeCreacion" ).datepicker( "option", "dateFormat", 'dd-mm-yy' );			
		$( "#fechaDeVencimiento" ).datepicker( "option", "dateFormat", 'dd-mm-yy' );
		
	if ( fechaC != '') {
		$("#fechaDeCreacion").val($.format.date(fechaC, 'dd-MM-yyyy'));
		if ( fechaV != '') 
			$("#fechaDeVencimiento").val($.format.date(fechaV, 'dd-MM-yyyy'));

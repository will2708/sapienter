            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="enlaceUtil.descripcion.label" default="Descripcion" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="enlaceUtil.direccion.label" default="Direccion" /></td>
